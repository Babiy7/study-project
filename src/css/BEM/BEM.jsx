...
function BEM(props) {
    ...
    const miksAbout = (
        <div className="about">
            ...
            <div className="about__subtitle subtitle"></div>
        </div>
    )
    ...
    const menu = (
        <nav className="menu">
            <a href="" className="menu__item menu__item_active"></a>
            <a href="" className="menu__item"></a>
            <a href="" className="menu__item"></a>
            <a href="" className="menu__item"></a>
            <a href="" className="menu__item"></a>
        </nav>
                ...
                <div className="about__row">
                    <div className="about__column">
                        <div className="item-about">
                            <div className="item-about__icon"></div>
                    ...
                    <div className="about__column">
                        <div className="item-about">
                            ...
                            <div className="item-about__text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Minima fugit iste sequi nam beatae corporis enim quibusdam illo, consequatur temporibus facilis commodi quam accusamus voluptatum at atque nihil aperiam nulla.</div>
                        </div>
                    </div>
                </div>
            </div>
